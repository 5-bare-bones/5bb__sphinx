...
`sphinx generate phrase [--copy] [--length {}] [--separator {}] [--include {}] [--exclude {}] [--mute {}] [--list {}] [--qr]`
...
```
sphinx generate phrase --length 6
```

Generate a passphrase with word list:
```
sphinx generate phrase --length 7 --list WordList
```

Generate a passphrase with syllable list:
```
sphinx generate phrase --length 12 --list SyllableList
```
