...
`sphinx entry add {name} [--custom] [--length {}] [--levels {}] [--include {}] [--exclude {}] [--repeat {}]`
...
- `sphinx add phrase`: Create a new entry using a passphrase.
...
Standard:
```
sphinx add Sample --length 10 --levels 1,2,3,4,5
```

Using shorthands and allowing repetition:
```
sphinx add Sample -l 10 -L 1,2,3,4,5 -r
```

Using a custom password:
```
sphinx add Sample --custom
```
